    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quenMK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTitle("Reset Forgot Passwoed?")
...
//                                        intent.putExtra("login_type", "email"); // Gửi dữ liệu đánh dấu loại đăng nhập
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        if (user != null) {
                                            ...
                                            if (user.isEmailVerified()) {
                                                ...
                                                // Email chưa được xác minh, gửi lại email xác minh
                                                        ...
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    ...
                                                                    Toast.makeText(DangNhap.this, "Email xác minh đã được gửi lại. Vui lòng kiểm tra hòm thư đến.", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    // Gửi email xác minh thất bại
                                                                    Toast.makeText(DangNhap.this, "Gửi lại email xác minh thất bại. Vui lòng thử lại sau.", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        });
                                            }
                                        ...
                                        Toast.makeText(DangNhap.this, "Đăng nhập không thành công. Hãy kiểm tra lại email và mật khẩu.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
